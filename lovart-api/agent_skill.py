...
def main():
    ...
    p.add_argument("--attachments", nargs="*", default=None)
    p.add_argument("--json", action="store_true",
                   help="Compatibility flag. watch always emits NDJSON regardless of this option.")
    ...
    p = sub.add_parser("project-add", help="Register and activate an existing project")
    p.add_argument("--project-id", required=True)
    ...
    p.add_argument("--all", action="store_true", help="List threads across all saved projects")
    p.add_argument("--json", action="store_true")
